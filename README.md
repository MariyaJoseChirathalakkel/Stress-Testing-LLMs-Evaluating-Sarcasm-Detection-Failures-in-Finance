...
You have to find a one-word topic for each and every parent comment and comment pair. It should be strictly a one-word topic. Do not use any punctuation or special characters.
...
Now your task is to analyse the relationship between two comments and find the reply comment is a sarcastic reply to the parent comment.
